...
export const MenuItem = ({ menuItem }) => {
    ...
    const verifyIfItemIsOnSale = () => {
      ...
      const finalPrice = (selectedSale?.price ?? menuItem?.price ?? 0) * quantity
      ...
      return (
      <Styled.Wrapper onClick={() => setModalIsVisible(true)}>
        {modalIsVisible &&(
          <Styled.ModalOverlay>
            <Styled.ModalContent>
              <div
              ...
              <div className="footer">
                <button className="quantityBtn" type="button">
                ...
                >
                  <span>Adicionar</span>
                  <span>{convertToLocaleString(finalPrice)}</span>
                </button>
              </div>
            </Styled.ModalContent>
          </Styled.ModalOverlay>
